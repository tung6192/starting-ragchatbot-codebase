    ...
    def _format_results(self, results: SearchResults) -> str:
        ...
        for doc, meta in zip(results.documents, results.metadata):
            ...
            if source_text not in seen_sources:
                ...
                # Get lesson link and format as markdown if available
                link = None
                if lesson_num is not None:
...
class CourseOutlineTool(Tool):
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "description": "Get the complete outline of a course including course title, course link, and list of all lessons with their numbers and titles. Use this for questions about course structure, lesson lists, or what topics a course covers.",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_name": {
    ...
    def execute(self, course_name: str) -> str:
        ...
        Args:
            course_name: The course title to look up
